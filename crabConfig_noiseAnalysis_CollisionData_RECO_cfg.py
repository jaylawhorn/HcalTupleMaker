...
# List of datasets
datasetnames = [
'/ZeroBias/Run2017B-v1/RAW'
]

# Storage path for output files - EOS specific
storagepath = '/store/user/'+getUsernameFromSiteDB()+'/HEP17_PHASE_SCAN'
...
# Output filename
OutputFilename = 'HcalTupleMaker.root'
...
config.General.workArea        = "crabTiming3"
...
config.Data.runRange         = '297099-297101'
#config.Data.runRange         = '294927-294972'
# -----------------------------------------------------------------------------------------------------------------------------
